 ...
 * File: test-app/src/pages/TestPage.tsx
 * Route: /testpage
...
export class TestPage {
  ...
  selectors = {
  button_submit_form: '[data-testid="submit-btn"]', // button - testid (confidence: 10/10)
  input_enter_email: '[data-testid="email-input"]', // input - testid (confidence: 10/10)
  ...
  input_search_products: 'input[placeholder="Search products..."]', // input - attribute (confidence: 7/10)
  input_enter_password: 'input[placeholder="Enter password"]', // input - attribute (confidence: 7/10)
  button_: 'button=×', // button - semantic (confidence: 9/10)
  select_select_country: '[aria-label="Select country"]', // select - attribute (confidence: 8/10)
  input_username: 'input[name="username"]', // input - attribute (confidence: 8/10)
  select_test: 'select', // select - fallback (confidence: 3/10)
  button_save: 'button=Save', // button - semantic (confidence: 9/10)
  input_text: 'input[type="text"]', // input - attribute (confidence: 6/10)
  button_generic_button_1: 'button=Generic Button 1', // button - semantic (confidence: 9/10)
  button_generic_button_2: 'button=Generic Button 2', // button - semantic (confidence: 9/10)
  input_text: 'input[type="text"]', // input - attribute (confidence: 6/10)
  select_test: 'select', // select - fallback (confidence: 3/10)
  };
  ...
  async fillInput_enter_email(text: string): Promise<void> {
    await this.page.locator('[data-testid="email-input"]').fill(text);
  }
